...
- **Vorwellen:** `finalization/WAVE_04_core_business.md` (A Hofladen-Finder — Track B ist dessen vertikale Vertiefung), `WAVE_10` (Premium UX/Mobile/Leerzustände), `WAVE_11_database.md` (Indizes/Pagination — `0007` knüpft daran an), `TRACK_E_DATABASE.md` (Geo-Index/BBox bei realer Last).
